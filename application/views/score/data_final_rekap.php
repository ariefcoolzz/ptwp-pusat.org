...
// PRINT_R($_SESSION);
// DIE();
$result = $this->Model_score->model_data_final_rekap($_POST);
if (!$result->num_rows()) {
    ...
    echo "
        <thead class='text-center align-middle'>
                <tr>
                    ...
                    <th class='d-none d-lg-table-cell'> Per </th>
    ...
    foreach ($result->result_array() as $R) {
        ...
        echo '<td class="d-none d-lg-table-cell">' . $R['per'] . '</td>';
...
<script>
    ...
    $(".table").on('click', '.edit', function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>score/data_final_form",
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
