<div class="row">
	...
	<div class="col-sm text-center">
		<div class="row">
			<div class="col-sm">
				<H1 class="pt-4" id="<?php echo $id_tim_A; ?>"><?php echo $set1_tim_A; ?></H1>
			</div>
			<div class="col-sm">
			...
			<div class="col-sm">
				<H1 class="pt-4" id="<?php echo $id_tim_B; ?>"><?php echo $set1_tim_B; ?></H1>
			</div>
		</div>
	</div>
	<div class="col-sm">
...
$('.btn-nilai').on('click', function (e) {
		...
		$.ajax({
            url: "<?php echo base_url(); ?>admin/set_nilai_penyisihan",
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
