                ...
                <form id='form_konten' enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label class="control-label">Babak :</label>
                                <select id="kategori_babak" name="kategori_babak" class="form-control">
                                    <?php 
                                    
                                    foreach($kategori_babak->result_array() as $R){
                                        $selected = '';
                                        if($R['id_babak'] == 1) $activ = 'selected';
                                        echo '<option value="'.$R['id_babak'].'">'.$R['nama'].'</option>';
                                    }
                                ?>
                                </select>
                            </div>
...
<script>
    ...
    $("#form_konten").submit(function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>admin/form_data_turnamen_simpan",
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
    ...
    function get_nama_tim_A(){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>admin/get_nama_tim_turnamen",
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
