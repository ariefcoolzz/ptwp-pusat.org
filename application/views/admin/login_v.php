  ...
  <div class="container">
    <div class="media align-items-stretch justify-content-center ht-100p pos-relative">
      <div class="media-body align-items-center d-none d-lg-flex">
        <div class="mx-wd-600">
          <img src="<?php echo base_url() ?>assets/img/piala_kma_iv_jogjakarta.jpeg" class="img-fluid" alt="">
        </div>
      ...
      <form action="<?php echo base_url(); ?>login/signin" method="post">
        <div class="wd-100p">
          ...
          <div class="tx-13 mg-t-20 tx-center">Belum Punya Akun? <a href="<?php echo base_url(); ?>register">Silahkan Mendaftar</a></div>
        </div>
        </form>
      </div><!-- sign-wrapper -->
    </div><!-- media -->
