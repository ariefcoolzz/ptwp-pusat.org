<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
    <div>
        ...
        <a href="#" onClick="tambah_data_turnamen(0,0)" id_pemain="0" class="btn-tambah btn btn-info btn-xs"><i class="fa fa-plus-circle"></i> Tambah DATA Turnamen Baru</a>
	</div>
</div>
<div class="row">
    <div class="col-12">
					...
					<div class="tab-content bd bd-gray-300 bd-t-0 pd-20" id="MyTabPTWP">
						<?php 
							foreach($kategori->result_array() as $R){
								...
								$data 	= $this->Model_admin->get_data_turnamen($R['id_kategori']);
								$no = 0;
								if (COUNT($data->result_array())) {
									...
									foreach ($data->result_array() as $T) {
										...
										echo '<td class="text-center">'.$T['per_babak'].'</td>';
								...
								<tr>
								<th colspan="10" class="text-white">Jumlah Pertandingan: '.$no.'</th>
								</tr>
								</tfoot></table>';
								echo '</div>';
							}
...
<script>
    ...
    function tambah_data_turnamen(Tim_A,Tim_B) {
        //loader
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>admin/form_data_turnamen_tambah",
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
