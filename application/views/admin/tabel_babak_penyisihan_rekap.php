...
$list_kategori = $this->Model_admin->list_kategori_pemain($_POST);
...
if (!$result->num_rows()) {
    ...
    echo "<table border='1' width='100%' class='table table-primary table-bordered table-hover'>";
    echo "
		<tr>
		<th>No.</th>
		<th>Beregu</th>
