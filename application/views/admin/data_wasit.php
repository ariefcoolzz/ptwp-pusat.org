    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                ...
                <li class="breadcrumb-item active" aria-current="page">Data Wasit</li>
            </ol>
        </nav>
        <div class="row">
            <div class="form-group ml-4">
                <a href="javascript:void(0)" id='tambah' class="btn-tambah btn btn-primary"><i class="fa fa-plus-circle"></i> Data Wasit</a>
            </div>
        </div>
...
<script>
    ...
    function load_data() {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>admin/data_wasit_tabel",
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
