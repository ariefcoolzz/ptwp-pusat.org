    ...
    foreach ($result->result_array() as $R) {
        ...
        foreach ($result->result_array() as $L) {
            ...
            if ($L['beregu'] == 'putri') {
				...
				echo "kontingen A  :".$iktA."<br>";
				echo "kontingen B  :".$iktB."<br>";
				if (isset($score_tim_A[1][6][$iktA][$iktB])) echo "skore : ".$score_tim_A[1][6][$iktA][$iktB]."<br>";
				if (isset($score_tim_A[1][7][$iktA][$iktB])) echo "skore : ".$score_tim_A[1][7][$iktA][$iktB]."<br>";
				if (isset($score_tim_A[1][8][$iktA][$iktB])) echo "skore : ".$score_tim_A[1][8][$iktA][$iktB]."<br>";
				echo "menang : ".$menang."<br>";
				echo "kalah : ".$kalah."<br>";
            }
