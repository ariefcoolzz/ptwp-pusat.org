            ...
            <div data-aos="zoom-in" data-aos-duration="3000">
                <div class="d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex flex-column flex-sm-row mg-t-20 mg-md-t-0">
                        ...
                        <button data-link='https://www.youtube.com/embed/1y3QDbGNMos' class='tonton_pembukaan btn btn-danger'><i class='fa fa-youtube-play'></i> Siaran Langsung</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function() {
        ...
        $('#popup_streaming').on('show.bs.modal', function(event) {
        ...
        $('#popup_streaming').on('hidden.bs.modal', function(e) {
