				...
				IF($R['urutan'] <= 8)
					{
						...
						?>
						<ul class="matchup">
							<li class="team team-top">		<span class='nama'><?php echo $R['nama_tim_A']; ?></span><span class="score1"></span><span class="score2"></span><span class="score3"><?php echo $R['set1_tim_A'];?></span></li>
							<li class="team team-bottom">	<span class='nama'><?php echo $R['nama_tim_B']; ?></span><span class="score1"></span><span class="score2"></span><span class="score3"><?php echo $R['set1_tim_B'];?></span></li>
						</ul>
						<?php
					}
			}
