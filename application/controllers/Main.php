...
class Main extends CI_Controller
{
	...
	public function register_simpan()
	{
		...
		if ($_POST['password'] === $_POST['password_confirm']) {
			...
			// $kirim_ke = array('6285712423460', '6282120494550', '628114043343', '6281281419338', '628118689789','6281310844644','6281298078787','6281294498677'); //PUTRA, REZA, ILMAN, CANDRA BOY
			$kirim_ke = array('6285712423460'); //PUTRA
	...
	public function data_klasemen()
	{
		$data['judul'] = "DATA POOL";
		$this->template->load('ptwp_template', 'main/data_klasemen', $data);
	}

	public function data_klasemen_rekap()
	{
		OB_START();
		$this->load->view('main/data_klasemen_rekap');
		$konten = ob_get_clean();
		echo JSON_ENCODE(array("status" => TRUE, "konten" => $konten));
	}
