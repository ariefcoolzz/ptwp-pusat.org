...
class Score extends CI_Controller
{
	...
	public function manage($kategori,$id_pertandingan)
	{
		IF(!IN_ARRAY($kategori, ARRAY("penyisihan","final"))) DIE("Maaf... Kategori ini tidak valid");
			
		$this->load->view("score/score_manage");
	}
